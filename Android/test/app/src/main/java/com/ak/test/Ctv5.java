...
public class Ctv5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Ctv5.this,Ctv5Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Ctv5.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        TvAdapter5 tvAdapter5 = new TvAdapter5(this);
        pager.setAdapter(tvAdapter5);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = tvAdapter5.getCount();
