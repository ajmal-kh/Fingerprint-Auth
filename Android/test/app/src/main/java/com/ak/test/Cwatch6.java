...
public class Cwatch6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cwatch6);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cwatch6.this,Cwatch6Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cwatch6.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        WatchAdapter6 watchAdapter6 = new WatchAdapter6(this);
        pager.setAdapter(watchAdapter6);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = watchAdapter6.getCount();
