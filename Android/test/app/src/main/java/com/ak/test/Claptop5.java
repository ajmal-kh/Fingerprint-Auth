...
public class Claptop5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.claptop5);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Claptop5.this,Claptop5Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Claptop5.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        LaptopAdapter5 laptopAdapter5 = new LaptopAdapter5(this);
        pager.setAdapter(laptopAdapter5);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = laptopAdapter5.getCount();
