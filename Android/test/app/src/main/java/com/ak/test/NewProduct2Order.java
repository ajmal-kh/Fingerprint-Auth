...
public class NewProduct2Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_product2_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("New Product2");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(NewProduct2Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(NewProduct2Order.this,OrderSuccessfull1.class);
