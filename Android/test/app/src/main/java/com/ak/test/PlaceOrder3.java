...
public class PlaceOrder3 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_order3);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("PopularProduct3");
    ...
    public void addUsers(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(PlaceOrder3.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(PlaceOrder3.this,OrderSuccessfull3.class);
