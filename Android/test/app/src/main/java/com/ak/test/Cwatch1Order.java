...
public class Cwatch1Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cwatch1_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("watch1");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cwatch1Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cwatch1Order.this,OrderSuccessfull1.class);
