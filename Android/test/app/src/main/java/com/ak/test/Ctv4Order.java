...
public class Ctv4Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ctv4_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("tv4");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Ctv4Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Ctv4Order.this,OrderSuccessfull1.class);
