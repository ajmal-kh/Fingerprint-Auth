...
public class NewProduct5Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_product5_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("New Product5");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(NewProduct5Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(NewProduct5Order.this,OrderSuccessfull1.class);
