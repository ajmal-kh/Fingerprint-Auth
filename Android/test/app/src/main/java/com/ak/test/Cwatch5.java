...
public class Cwatch5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cwatch5);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cwatch5.this,Cwatch5Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cwatch5.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        WatchAdapter5 watchAdapter5 = new WatchAdapter5(this);
        pager.setAdapter(watchAdapter5);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = watchAdapter5.getCount();
