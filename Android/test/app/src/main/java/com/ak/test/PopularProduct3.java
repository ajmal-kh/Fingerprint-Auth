...
public class PopularProduct3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_popular_product3);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PopularProduct3.this,PopularProduct3.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(PopularProduct3.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        PpAdapter3 ppAdapter3 = new PpAdapter3(this);
        pager.setAdapter(ppAdapter3);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = ppAdapter3.getCount();
