...
public class NewProduct3Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_product3_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("New Product3");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(NewProduct3Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(NewProduct3Order.this,OrderSuccessfull1.class);
