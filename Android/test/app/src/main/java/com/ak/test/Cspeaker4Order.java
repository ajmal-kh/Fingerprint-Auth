...
public class Cspeaker4Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cspeaker4_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("speaker4");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cspeaker4Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cspeaker4Order.this,OrderSuccessfull1.class);
