...
public class NewProduct5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_product5);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(NewProduct5.this,NewProduct5Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(NewProduct5.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        NpAdapter5 npAdapter5 = new NpAdapter5(this);
        pager.setAdapter(npAdapter5);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = npAdapter5.getCount();
