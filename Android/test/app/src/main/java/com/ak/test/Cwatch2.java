...
public class Cwatch2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cwatch2);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cwatch2.this,Cwatch2Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cwatch2.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        WatchAdapter2 watchAdapter2 = new WatchAdapter2(this);
        pager.setAdapter(watchAdapter2);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = watchAdapter2.getCount();
