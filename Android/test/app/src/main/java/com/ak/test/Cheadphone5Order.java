...
public class Cheadphone5Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cheadphone5_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("headphone5");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cheadphone5Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cheadphone5Order.this,OrderSuccessfull1.class);
