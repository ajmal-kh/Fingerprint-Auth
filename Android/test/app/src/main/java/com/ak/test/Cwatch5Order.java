...
public class Cwatch5Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cwatch5_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("watch5");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cwatch5Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cwatch5Order.this,OrderSuccessfull1.class);
