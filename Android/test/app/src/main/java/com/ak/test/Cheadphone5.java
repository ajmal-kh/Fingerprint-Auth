...
public class Cheadphone5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cheadphone5);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cheadphone5.this,Cheadphone5Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cheadphone5.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        HeadphoneAdapter5 headphoneAdapter5 = new HeadphoneAdapter5(this);
        pager.setAdapter(headphoneAdapter5);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = headphoneAdapter5.getCount();
