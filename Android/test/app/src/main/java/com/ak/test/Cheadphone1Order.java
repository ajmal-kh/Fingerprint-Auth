...
public class Cheadphone1Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cheadphone1_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("headphone1");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cheadphone1Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cheadphone1Order.this,OrderSuccessfull1.class);
