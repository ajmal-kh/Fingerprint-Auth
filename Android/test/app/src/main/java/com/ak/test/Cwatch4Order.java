...
public class Cwatch4Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cwatch4_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("watch4");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cwatch4Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cwatch4Order.this,OrderSuccessfull1.class);
