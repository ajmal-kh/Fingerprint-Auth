...
public class Claptop3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.claptop3);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Claptop3.this,Claptop3Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Claptop3.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        LaptopAdapter3 laptopAdapter3 = new LaptopAdapter3(this);
        pager.setAdapter(laptopAdapter3);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = laptopAdapter3.getCount();
