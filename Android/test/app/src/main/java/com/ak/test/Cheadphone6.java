...
public class Cheadphone6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cheadphone6);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cheadphone6.this,Cheadphone6Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cheadphone6.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        HeadphoneAdapter6 headphoneAdapter6 = new HeadphoneAdapter6(this);
        pager.setAdapter(headphoneAdapter6);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = headphoneAdapter6.getCount();
