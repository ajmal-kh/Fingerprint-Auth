...
public class Ctv2Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ctv2_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("tv2");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Ctv2Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Ctv2Order.this,OrderSuccessfull1.class);
