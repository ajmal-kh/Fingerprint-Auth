...
public class Cmobile1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cmobile1);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cmobile1.this,Cmobile1Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cmobile1.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        MobileAdapter1 mobileAdapter1 = new MobileAdapter1(this);
        pager.setAdapter(mobileAdapter1);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = mobileAdapter1.getCount();
