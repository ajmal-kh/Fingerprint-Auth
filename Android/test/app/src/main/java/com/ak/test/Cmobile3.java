...
public class Cmobile3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cmobile3);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cmobile3.this,Cmobile3Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cmobile3.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        MobileAdapter3 mobileAdapter3 = new MobileAdapter3(this);
        pager.setAdapter(mobileAdapter3);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = mobileAdapter3.getCount();
