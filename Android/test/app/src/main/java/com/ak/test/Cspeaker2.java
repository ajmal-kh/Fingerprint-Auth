...
public class Cspeaker2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cspeaker2);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cspeaker2.this,Cspeaker2Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cspeaker2.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        SpeakerAdapter2 speakerAdapter2 = new SpeakerAdapter2(this);
        pager.setAdapter(speakerAdapter2);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = speakerAdapter2.getCount();
