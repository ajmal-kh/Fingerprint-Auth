...
public class Claptop5Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.claptop5_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("laptop5");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Claptop5Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Claptop5Order.this,OrderSuccessfull1.class);
