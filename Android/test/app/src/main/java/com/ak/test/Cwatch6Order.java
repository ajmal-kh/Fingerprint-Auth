...
public class Cwatch6Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cwatch6_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("watch6");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cwatch6Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cwatch6Order.this,OrderSuccessfull1.class);
