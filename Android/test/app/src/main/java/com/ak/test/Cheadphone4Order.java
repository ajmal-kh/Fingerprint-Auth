...
public class Cheadphone4Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cheadphone4_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("headphone4");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cheadphone4Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cheadphone4Order.this,OrderSuccessfull1.class);
