...
public class Cmobile3Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cmobile3_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("OnePlus 6T");
    ...
    public void addUsers(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cmobile3Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cmobile3Order.this,OrderSuccessfull1.class);
