...
public class Cheadphone3Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cheadphone3_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("headphone3");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cheadphone3Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cheadphone3Order.this,OrderSuccessfull1.class);
