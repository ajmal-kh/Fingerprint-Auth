...
public class Cspeaker3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cspeaker3);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cspeaker3.this,Cspeaker3Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cspeaker3.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        SpeakerAdapter3 speakerAdapter3 = new SpeakerAdapter3(this);
        pager.setAdapter(speakerAdapter3);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = speakerAdapter3.getCount();
