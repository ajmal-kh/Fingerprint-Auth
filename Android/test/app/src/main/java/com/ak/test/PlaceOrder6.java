...
public class PlaceOrder6 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_order6);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("PopularProduct6");
    ...
    public void addUsers(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(PlaceOrder6.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(PlaceOrder6.this,OrderSuccessfull3.class);
