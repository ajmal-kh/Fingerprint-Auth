...
public class Claptop1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.claptop1);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Claptop1.this,Claptop1Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Claptop1.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        LaptopAdapter1 laptopAdapter1 = new LaptopAdapter1(this);
        pager.setAdapter(laptopAdapter1);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = laptopAdapter1.getCount();
