...
public class Ctv6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Ctv6.this,Ctv6Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Ctv6.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        TvAdapter6 tvAdapter6 = new TvAdapter6(this);
        pager.setAdapter(tvAdapter6);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = tvAdapter6.getCount();
