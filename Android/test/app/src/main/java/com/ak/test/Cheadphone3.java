...
public class Cheadphone3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cheadphone3);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cheadphone3.this,Cheadphone3Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cheadphone3.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        HeadphoneAdapter3 headphoneAdapter3 = new HeadphoneAdapter3(this);
        pager.setAdapter(headphoneAdapter3);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = headphoneAdapter3.getCount();
