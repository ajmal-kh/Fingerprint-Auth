...
public class Cmobile1Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cmobile1_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Oppo R17");
    ...
    public void addUsers(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cmobile1Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cmobile1Order.this,OrderSuccessfull1.class);
