...
public class Claptop4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.claptop4);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Claptop4.this,Claptop4Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Claptop4.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        LaptopAdapter4 laptopAdapter4 = new LaptopAdapter4(this);
        pager.setAdapter(laptopAdapter4);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = laptopAdapter4.getCount();
