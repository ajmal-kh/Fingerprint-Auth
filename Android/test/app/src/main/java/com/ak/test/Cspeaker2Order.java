...
public class Cspeaker2Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cspeaker2_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("speaker2");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cspeaker2Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cspeaker2Order.this,OrderSuccessfull1.class);
