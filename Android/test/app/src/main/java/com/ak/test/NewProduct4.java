...
public class NewProduct4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_product4);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(NewProduct4.this,NewProduct4Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(NewProduct4.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        NpAdapter4 npAdapter4 = new NpAdapter4(this);
        pager.setAdapter(npAdapter4);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = npAdapter4.getCount();
