...
public class Cwatch3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cwatch3);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cwatch3.this,Cwatch3Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cwatch3.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        WatchAdapter3 watchAdapter3 = new WatchAdapter3(this);
        pager.setAdapter(watchAdapter3);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = watchAdapter3.getCount();
