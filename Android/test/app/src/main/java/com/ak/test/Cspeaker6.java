...
public class Cspeaker6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cspeaker6);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cspeaker6.this,Cspeaker6Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cspeaker6.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        SpeakerAdapter6 speakerAdapter6 = new SpeakerAdapter6(this);
        pager.setAdapter(speakerAdapter6);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = speakerAdapter6.getCount();
