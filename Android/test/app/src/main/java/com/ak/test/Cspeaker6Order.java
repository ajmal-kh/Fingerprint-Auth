...
public class Cspeaker6Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cspeaker6_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("speaker6");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cspeaker6Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cspeaker6Order.this,OrderSuccessfull1.class);
