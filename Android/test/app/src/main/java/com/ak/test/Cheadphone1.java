...
public class Cheadphone1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cheadphone1);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cheadphone1.this,Cheadphone1Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cheadphone1.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        HeadphoneAdapter1 headphoneAdapter1 = new HeadphoneAdapter1(this);
        pager.setAdapter(headphoneAdapter1);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = headphoneAdapter1.getCount();
