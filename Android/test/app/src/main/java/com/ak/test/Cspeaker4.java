...
public class Cspeaker4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cspeaker4);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cspeaker4.this,Cspeaker4Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cspeaker4.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        SpeakerAdapter4 speakerAdapter4 = new SpeakerAdapter4(this);
        pager.setAdapter(speakerAdapter4);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = speakerAdapter4.getCount();
