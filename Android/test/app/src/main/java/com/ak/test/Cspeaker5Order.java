...
public class Cspeaker5Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cspeaker5_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("speaker5");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cspeaker5Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cspeaker5Order.this,OrderSuccessfull1.class);
