...
public class Ctv4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Ctv4.this,Ctv4Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Ctv4.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        TvAdapter4 tvAdapter4 = new TvAdapter4(this);
        pager.setAdapter(tvAdapter4);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = tvAdapter4.getCount();
