...
public class Cheadphone2Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cheadphone2_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("headphone2");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cheadphone2Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cheadphone2Order.this,OrderSuccessfull1.class);
