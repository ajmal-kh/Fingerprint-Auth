...
public class NewProduct1Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_product1_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("New Product1");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(NewProduct1Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(NewProduct1Order.this,OrderSuccessfull1.class);
