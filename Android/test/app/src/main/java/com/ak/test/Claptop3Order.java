...
public class Claptop3Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.claptop3_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("laptop3");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Claptop3Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Claptop3Order.this,OrderSuccessfull1.class);
