...
public class Cmobile2Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cmobile2_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Mi A2");
    ...
    public void addUsers(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cmobile2Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cmobile2Order.this,OrderSuccessfull1.class);
