...
public class Ctv3Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ctv3_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("tv3");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Ctv3Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Ctv3Order.this,OrderSuccessfull1.class);
