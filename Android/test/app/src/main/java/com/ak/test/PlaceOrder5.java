...
public class PlaceOrder5 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_order5);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("PopularProduct5");
    ...
    public void addUsers(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(PlaceOrder5.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(PlaceOrder5.this,OrderSuccessfull3.class);
