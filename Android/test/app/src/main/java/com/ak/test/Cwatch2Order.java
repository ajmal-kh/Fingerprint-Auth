...
public class Cwatch2Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cwatch2_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("watch2");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cwatch2Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cwatch2Order.this,OrderSuccessfull1.class);
