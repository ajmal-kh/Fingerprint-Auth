...
public class NewProduct2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_product2);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(NewProduct2.this,NewProduct2Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(NewProduct2.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        NpAdapter2 npAdapter2 = new NpAdapter2(this);
        pager.setAdapter(npAdapter2);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = npAdapter2.getCount();
