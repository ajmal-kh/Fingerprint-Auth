...
public class Ctv2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Ctv2.this,Ctv2Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Ctv2.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        TvAdapter2 tvAdapter2 = new TvAdapter2(this);
        pager.setAdapter(tvAdapter2);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = tvAdapter2.getCount();
