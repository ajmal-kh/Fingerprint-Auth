...
public class Cmobile4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cmobile4);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cmobile4.this,Cmobile4Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cmobile4.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        MobileAdapter4 mobileAdapter4 = new MobileAdapter4(this);
        pager.setAdapter(mobileAdapter4);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = mobileAdapter4.getCount();
