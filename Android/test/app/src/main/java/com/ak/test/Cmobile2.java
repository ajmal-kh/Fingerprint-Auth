...
public class Cmobile2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cmobile2);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cmobile2.this,Cmobile2Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cmobile2.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        MobileAdapter2 mobileAdapter2 = new MobileAdapter2(this);
        pager.setAdapter(mobileAdapter2);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = mobileAdapter2.getCount();
