...
public class Cmobile4Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cmobile4_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Honor 10 Lite");
    ...
    public void addUsers(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cmobile4Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cmobile4Order.this,OrderSuccessfull1.class);
