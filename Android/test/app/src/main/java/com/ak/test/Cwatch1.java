...
public class Cwatch1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cwatch1);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cwatch1.this,Cwatch1Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cwatch1.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        WatchAdapter1 watchAdapter1 = new WatchAdapter1(this);
        pager.setAdapter(watchAdapter1);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = watchAdapter1.getCount();
