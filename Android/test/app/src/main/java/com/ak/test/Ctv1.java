...
public class Ctv1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Ctv1.this,Ctv1Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Ctv1.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        TvAdapter1 tvAdapter1 = new TvAdapter1(this);
        pager.setAdapter(tvAdapter1);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = tvAdapter1.getCount();
