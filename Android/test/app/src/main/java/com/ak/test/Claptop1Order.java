...
public class Claptop1Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.claptop1_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("laptop1");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Claptop1Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Claptop1Order.this,OrderSuccessfull1.class);
