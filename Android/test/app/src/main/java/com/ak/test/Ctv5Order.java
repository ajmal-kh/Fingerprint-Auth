...
public class Ctv5Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ctv5_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("tv5");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Ctv5Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Ctv5Order.this,OrderSuccessfull1.class);
