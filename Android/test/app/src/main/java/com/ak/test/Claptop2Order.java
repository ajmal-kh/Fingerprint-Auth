...
public class Claptop2Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.claptop2_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("laptop2");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Claptop2Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Claptop2Order.this,OrderSuccessfull1.class);
