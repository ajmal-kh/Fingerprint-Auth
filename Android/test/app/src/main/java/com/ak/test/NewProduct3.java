...
public class NewProduct3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_product3);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(NewProduct3.this,NewProduct1Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(NewProduct3.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        NpAdapter3 npAdapter3 = new NpAdapter3(this);
        pager.setAdapter(npAdapter3);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = npAdapter3.getCount();
