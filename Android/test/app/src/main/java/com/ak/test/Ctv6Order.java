...
public class Ctv6Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ctv6_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("tv6");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Ctv6Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Ctv6Order.this,OrderSuccessfull1.class);
