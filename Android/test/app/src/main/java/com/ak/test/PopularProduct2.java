...
public class PopularProduct2 extends AppCompatActivity {
    private Button bvBuyNow, bvA2Cart;
    public TextView pp2_pn,pp2_price;
    ViewPager pager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_popular_product2);

        bvBuyNow = (Button) findViewById(R.id.bvBuyNow);
        bvA2Cart = (Button) findViewById(R.id.bvA2Cart);
        pp2_pn = (TextView) findViewById(R.id.pp2_pn);
        pp2_price = (TextView) findViewById(R.id.pp2_price);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PopularProduct2.this,PlaceOrder2.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(PopularProduct2.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        PpAdapter2 ppAdapter2 = new PpAdapter2(this);
        pager.setAdapter(ppAdapter2);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = ppAdapter2.getCount();
