...
public class NewProduct1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_product1);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(NewProduct1.this,NewProduct1Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(NewProduct1.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        NpAdapter1 npAdapter1 = new NpAdapter1(this);
        pager.setAdapter(npAdapter1);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = npAdapter1.getCount();
