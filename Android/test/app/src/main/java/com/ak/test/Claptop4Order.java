...
public class Claptop4Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.claptop4_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("laptop4");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Claptop4Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Claptop4Order.this,OrderSuccessfull1.class);
