...
public class Cheadphone4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cheadphone4);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cheadphone4.this,Cheadphone4Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cheadphone4.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        HeadphoneAdapter4 headphoneAdapter4 = new HeadphoneAdapter4(this);
        pager.setAdapter(headphoneAdapter4);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = headphoneAdapter4.getCount();
