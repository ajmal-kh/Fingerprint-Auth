...
public class PlaceOrder4 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_order4);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("PopularProduct4");
    ...
    public void addUsers(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(PlaceOrder4.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(PlaceOrder4.this,OrderSuccessfull3.class);
