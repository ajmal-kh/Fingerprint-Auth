...
public class Cspeaker3Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cspeaker3_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("speaker3");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(Cspeaker3Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(Cspeaker3Order.this,OrderSuccessfull1.class);
