...
public class Cspeaker5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cspeaker5);
        ...
        bvBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cspeaker5.this,Cspeaker5Order.class);
        ...
        bvA2Cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Cspeaker5.this,"Item Added To Cart",Toast.LENGTH_SHORT).show();
            }
        });

        SpeakerAdapter5 speakerAdapter5 = new SpeakerAdapter5(this);
        pager.setAdapter(speakerAdapter5);

        //slider dots
        slideDots = (LinearLayout) findViewById(R.id.slideDots);
        dotscount = speakerAdapter5.getCount();
