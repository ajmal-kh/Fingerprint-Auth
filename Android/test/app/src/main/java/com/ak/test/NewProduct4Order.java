...
public class NewProduct4Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_product4_order);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("New Product4");
    ...
    public void addUser(){
        ...
        if(TextUtils.isEmpty(first))  {
            ...
            Toast.makeText(NewProduct4Order.this,"Order Successfull",Toast.LENGTH_SHORT).show();
            Intent intent= new Intent(NewProduct4Order.this,OrderSuccessfull1.class);
